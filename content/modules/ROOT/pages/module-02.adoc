...
Since we had issues with switching in our initial troubleshooting, log into the Bootc VM to test the new build.
...
==== _Switch to the "Bootc VM" tab to test the latest build of the image._
